...
const IndividualTier: React.FC<Props> = ({ individualTierRate }) => {
  return (
    <div className={styles.individual_tier_container}>
      ...
      <div className={styles.individual_tier_price}>
        <div className={styles.frame_840_cq0LNW}>
          ...
          <div className={styles.after_employer_contribution}>{GlobalStringConstant[0].after_employer_contribution}</div>
        </div>
