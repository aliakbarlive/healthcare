...
import styles from './NationalGeneralForm.module.scss'
import {
...
const NationalGeneralForm: React.FC<Props> = ({ application, group, user, userMetadata, groupMember, dependents, consumerProfile, next }) => {
...
export default NationalGeneralForm
